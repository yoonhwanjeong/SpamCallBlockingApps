...
.method private final a(JLokio/Buffer;ILjava/util/List;IILjava/util/List;)V
    ...
    .line 10
    invoke-virtual {v10, v2}, Lokio/Buffer;->G0(I)Lokio/Buffer;

    .line 11
    invoke-virtual {v10, v0}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    .line 14
    invoke-virtual {v10, v1}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    .line 22
    invoke-virtual {v10, v15}, Lokio/Buffer;->S(Lokio/Source;)J
    ...
    .line 26
    invoke-virtual {v10, v4}, Lokio/Buffer;->G0(I)Lokio/Buffer;
    ...
    .line 35
    invoke-virtual {v10, v11}, Lokio/Buffer;->S(Lokio/Source;)J
...
.method public final varargs d([Lokio/ByteString;)Lokio/Options;
    ...
    .line 3
    :cond_1
    invoke-static/range {p1 .. p1}, Lkotlin/collections/ArraysKt;->U([Ljava/lang/Object;)Ljava/util/List;

    move-result-object v1

    .line 4
    invoke-static {v1}, Lkotlin/collections/CollectionsKt;->s(Ljava/util/List;)V
    ...
    .line 18
    invoke-virtual {v9, v6}, Lokio/ByteString;->D(Lokio/ByteString;)Z
    ...
    .line 19
    :cond_5
    invoke-virtual {v9}, Lokio/ByteString;->C()I

    move-result v10

    invoke-virtual {v6}, Lokio/ByteString;->C()I
    ...
    .line 27
    :goto_8
    invoke-virtual {v2}, Lokio/Buffer;->z()Z
