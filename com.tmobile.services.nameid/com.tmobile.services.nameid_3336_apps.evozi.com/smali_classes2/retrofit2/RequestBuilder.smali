...
.method private static canonicalizeForPath(Ljava/lang/String;Z)Ljava/lang/String;
    ...
    .line 6
    invoke-virtual {v3, p0, v1, v2}, Lokio/Buffer;->N0(Ljava/lang/String;II)Lokio/Buffer;

    .line 7
    invoke-static {v3, p0, v2, v0, p1}, Lretrofit2/RequestBuilder;->canonicalizeForPath(Lokio/Buffer;Ljava/lang/String;IIZ)V

    .line 8
    invoke-virtual {v3}, Lokio/Buffer;->e0()Ljava/lang/String;
...
.method private static canonicalizeForPath(Lokio/Buffer;Ljava/lang/String;IIZ)V
    ...
    .line 11
    :cond_1
    invoke-virtual {p0, v1}, Lokio/Buffer;->O0(I)Lokio/Buffer;
    ...
    .line 13
    :cond_3
    invoke-virtual {v0, v1}, Lokio/Buffer;->O0(I)Lokio/Buffer;
    ...
    .line 16
    invoke-virtual {p0, v3}, Lokio/Buffer;->D0(I)Lokio/Buffer;
    ...
    invoke-virtual {p0, v4}, Lokio/Buffer;->D0(I)Lokio/Buffer;
