...
.method private final readCertificateList(Lokio/BufferedSource;)Ljava/util/List;
    ...
    .line 7
    sget-object v6, Lokio/ByteString;->j:Lokio/ByteString$Companion;
    ...
    invoke-virtual {v5, v4}, Lokio/Buffer;->z0(Lokio/ByteString;)Lokio/Buffer;

    .line 8
    invoke-virtual {v5}, Lokio/Buffer;->s0()Ljava/io/InputStream;
...
.method private final writeCertList(Lokio/BufferedSink;Ljava/util/List;)V
    ...
    invoke-interface {p1, v0, v1}, Lokio/BufferedSink;->q0(J)Lokio/BufferedSink;
    ...
    .line 4
    sget-object v4, Lokio/ByteString;->j:Lokio/ByteString$Companion;
    ...
    invoke-static/range {v4 .. v9}, Lokio/ByteString$Companion;->f(Lokio/ByteString$Companion;[BIIILjava/lang/Object;)Lokio/ByteString;
    ...
    .line 5
    invoke-interface {p1, v3}, Lokio/BufferedSink;->M(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v3

    invoke-interface {v3, v1}, Lokio/BufferedSink;->A(I)Lokio/BufferedSink;
    :try_end_0
...
.method public final writeTo(Lokhttp3/internal/cache/DiskLruCache$Editor;)V
    ...
    invoke-interface {p1, v3, v4}, Lokio/BufferedSink;->q0(J)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v5}, Lokio/BufferedSink;->M(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v5

    .line 7
    invoke-interface {v5, v4}, Lokio/BufferedSink;->M(Ljava/lang/String;)Lokio/BufferedSink;
    ...
    invoke-interface {v4, v5}, Lokio/BufferedSink;->M(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v4

    .line 9
    invoke-interface {v4, v2}, Lokio/BufferedSink;->A(I)Lokio/BufferedSink;
    ...
    invoke-interface {p1, v5, v6}, Lokio/BufferedSink;->q0(J)Lokio/BufferedSink;
    ...
    invoke-interface {v3, v5}, Lokio/BufferedSink;->M(Ljava/lang/String;)Lokio/BufferedSink;

    move-result-object v3

    .line 16
    invoke-interface {v3, v2}, Lokio/BufferedSink;->A(I)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v5, v6}, Lokio/BufferedSink;->q0(J)Lokio/BufferedSink;
    ...
    invoke-interface {v0, v3, v4}, Lokio/BufferedSink;->q0(J)Lokio/BufferedSink;
    ...
    .line 26
    invoke-interface {p1, v2}, Lokio/BufferedSink;->A(I)Lokio/BufferedSink;
