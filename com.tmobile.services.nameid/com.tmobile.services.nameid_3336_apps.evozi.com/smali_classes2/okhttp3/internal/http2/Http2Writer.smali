...
.method public final declared-synchronized connectionPreface()V
    ...
    invoke-interface {v0, v1}, Lokio/BufferedSink;->h0(Lokio/ByteString;)Lokio/BufferedSink;
...
.method public final frameHeader(IIII)V
    ...
    invoke-interface {p2, p3}, Lokio/BufferedSink;->A(I)Lokio/BufferedSink;
    ...
    invoke-interface {p2, p1}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
    ...
    invoke-interface {p1, p2}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->g0([B)Lokio/BufferedSink;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    invoke-virtual {p3}, Lokio/Buffer;->v0()J
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    invoke-interface {v2, p2}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v4, v3}, Lokio/BufferedSink;->s(I)Lokio/BufferedSink;
    ...
    invoke-interface {v3, v4}, Lokio/BufferedSink;->u(I)Lokio/BufferedSink;
