...
.method private final readControlFrame()V
    ...
    invoke-interface {v4, v5, v0, v1}, Lokio/BufferedSource;->D(Lokio/Buffer;J)V
    ...
    invoke-virtual {v0, v1}, Lokio/Buffer;->N(Lokio/Buffer$UnsafeCursor;)Lokio/Buffer$UnsafeCursor;
...
.method private final readMessage()V
    ...
    invoke-interface {v2, v3, v0, v1}, Lokio/BufferedSource;->D(Lokio/Buffer;J)V
