...
.method public constructor <init>(Lio/reactivex/ObservableSource;JJLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;JIZ)V
    ...
    .line 2
    iput-wide p2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->g:J

    .line 3
    iput-wide p4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->h:J

    .line 4
    iput-object p6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->i:Ljava/util/concurrent/TimeUnit;

    .line 5
    iput-object p7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->j:Lio/reactivex/Scheduler;

    .line 6
    iput-wide p8, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->k:J

    .line 7
    iput p10, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->l:I

    .line 8
    iput-boolean p11, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->m:Z
...
.method public subscribeActual(Lio/reactivex/Observer;)V
    ...
    .line 2
    iget-wide v2, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->g:J

    iget-wide v4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->h:J
    ...
    .line 3
    iget-wide v7, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->k:J
    ...
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->i:Ljava/util/concurrent/TimeUnit;

    iget-object v5, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->j:Lio/reactivex/Scheduler;

    iget v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->l:I
    ...
    iget-boolean v9, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->m:Z
    ...
    iget-object v6, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->i:Ljava/util/concurrent/TimeUnit;

    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->j:Lio/reactivex/Scheduler;
    ...
    iget v8, p0, Lio/reactivex/internal/operators/observable/ObservableWindowTimed;->l:I
