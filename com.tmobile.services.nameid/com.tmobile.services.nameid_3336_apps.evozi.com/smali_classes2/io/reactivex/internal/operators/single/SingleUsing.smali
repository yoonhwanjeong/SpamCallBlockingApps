...
.method protected k(Lio/reactivex/SingleObserver;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/single/SingleUsing;->f:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/single/SingleUsing;->g:Lio/reactivex/functions/Function;
    ...
    iget-boolean v3, p0, Lio/reactivex/internal/operators/single/SingleUsing;->i:Z

    iget-object v4, p0, Lio/reactivex/internal/operators/single/SingleUsing;->h:Lio/reactivex/functions/Consumer;
    ...
    .line 5
    iget-boolean v2, p0, Lio/reactivex/internal/operators/single/SingleUsing;->i:Z

    if-eqz v2, :cond_0

    .line 6
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/single/SingleUsing;->h:Lio/reactivex/functions/Consumer;
    ...
    .line 10
    iget-boolean p1, p0, Lio/reactivex/internal/operators/single/SingleUsing;->i:Z

    if-nez p1, :cond_1

    .line 11
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/single/SingleUsing;->h:Lio/reactivex/functions/Consumer;
