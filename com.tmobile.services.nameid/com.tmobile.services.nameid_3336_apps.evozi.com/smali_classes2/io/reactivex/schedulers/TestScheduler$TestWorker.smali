...
.field final synthetic g:Lio/reactivex/schedulers/TestScheduler;
...
.method constructor <init>(Lio/reactivex/schedulers/TestScheduler;)V
    ...
    .line 1
    iput-object p1, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->g:Lio/reactivex/schedulers/TestScheduler;
...
.method public a(Ljava/util/concurrent/TimeUnit;)J
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->g:Lio/reactivex/schedulers/TestScheduler;
...
.method public b(Ljava/lang/Runnable;)Lio/reactivex/disposables/Disposable;
    ...
    .line 1
    iget-boolean v0, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->f:Z
    ...
    iget-wide v5, v0, Lio/reactivex/schedulers/TestScheduler;->h:J

    const-wide/16 v8, 0x1

    add-long/2addr v8, v5

    iput-wide v8, v0, Lio/reactivex/schedulers/TestScheduler;->h:J
    ...
    .line 4
    iget-object p1, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->g:Lio/reactivex/schedulers/TestScheduler;

    iget-object p1, p1, Lio/reactivex/schedulers/TestScheduler;->g:Ljava/util/Queue;
...
.method public c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/Disposable;
    ...
    iget-wide v0, v0, Lio/reactivex/schedulers/TestScheduler;->i:J
    ...
    iget-object p2, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->g:Lio/reactivex/schedulers/TestScheduler;

    iget-wide v5, p2, Lio/reactivex/schedulers/TestScheduler;->h:J

    const-wide/16 p3, 0x1

    add-long/2addr p3, v5

    iput-wide p3, p2, Lio/reactivex/schedulers/TestScheduler;->h:J
...
.method public dispose()V
    ...
    .line 1
    iput-boolean v0, p0, Lio/reactivex/schedulers/TestScheduler$TestWorker;->f:Z
