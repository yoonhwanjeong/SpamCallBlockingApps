...
.method private static a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V
    ...
    .line 4
    sget-object v2, Landroidx/appcompat/content/res/AppCompatResources;->b:Ljava/util/WeakHashMap;
...
.method private static b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 5
    iget-object v3, v2, Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;->b:Landroid/content/res/Configuration;
    ...
    .line 6
    iget-object p0, v2, Landroidx/appcompat/content/res/AppCompatResources$ColorStateListCacheEntry;->a:Landroid/content/res/ColorStateList;
...
.method public static c(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 3
    :cond_0
    invoke-static {p0, p1}, Landroidx/appcompat/content/res/AppCompatResources;->b(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 4
    :cond_1
    invoke-static {p0, p1}, Landroidx/appcompat/content/res/AppCompatResources;->f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 5
    invoke-static {p0, p1, v0}, Landroidx/appcompat/content/res/AppCompatResources;->a(Landroid/content/Context;ILandroid/content/res/ColorStateList;)V

    return-object v0

    .line 6
    :cond_2
    invoke-static {p0, p1}, Landroidx/core/content/ContextCompat;->e(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
...
.method private static e()Landroid/util/TypedValue;
    ...
    .line 1
    sget-object v0, Landroidx/appcompat/content/res/AppCompatResources;->a:Ljava/lang/ThreadLocal;
...
.method private static f(Landroid/content/Context;I)Landroid/content/res/ColorStateList;
    ...
    .line 1
    invoke-static {p0, p1}, Landroidx/appcompat/content/res/AppCompatResources;->g(Landroid/content/Context;I)Z
    ...
    invoke-static {v0, p1, p0}, Landroidx/core/content/res/ColorStateListInflaterCompat;->a(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
...
.method private static g(Landroid/content/Context;I)Z
    ...
    .line 2
    invoke-static {}, Landroidx/appcompat/content/res/AppCompatResources;->e()Landroid/util/TypedValue;
