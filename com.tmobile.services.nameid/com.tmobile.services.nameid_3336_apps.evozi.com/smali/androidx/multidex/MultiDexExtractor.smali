...
.field private final k:Ljava/nio/channels/FileLock;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    .line 3
    iput-object p1, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;

    .line 4
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/io/File;
    ...
    iput-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->g:J
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->i:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->j:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    .line 10
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->j:Ljava/nio/channels/FileChannel;

    invoke-virtual {p2}, Ljava/nio/channels/FileChannel;->lock()Ljava/nio/channels/FileLock;

    move-result-object p2

    iput-object p2, p0, Landroidx/multidex/MultiDexExtractor;->k:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    .line 14
    :goto_1
    iget-object p2, p0, Landroidx/multidex/MultiDexExtractor;->i:Ljava/io/RandomAccessFile;
...
.method private a()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/io/File;
    ...
    iget-object v2, p0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/io/File;
...
.method private m(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    iget-object v9, v0, Landroidx/multidex/MultiDexExtractor;->h:Ljava/io/File;
    ...
    iput-wide v9, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
    ...
    .line 13
    iget-wide v2, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
    ...
    iget-wide v4, v8, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
...
.method private o()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    iget-object v0, v1, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    iget-object v12, v1, Landroidx/multidex/MultiDexExtractor;->h:Ljava/io/File;
    ...
    .line 10
    invoke-static {v8, v10, v11, v6}, Landroidx/multidex/MultiDexExtractor;->d(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    ...
    iput-wide v14, v11, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
    :try_end_1
    ...
    iget-wide v12, v11, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
...
.method private static p(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    iget-wide v0, p4, Landroidx/multidex/MultiDexExtractor$ExtractedDex;->f:J
...
.method public close()V
    ...
    .line 1
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->k:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    .line 2
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->j:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    .line 3
    iget-object v0, p0, Landroidx/multidex/MultiDexExtractor;->i:Ljava/io/RandomAccessFile;
...
.method l(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/multidex/MultiDexExtractor;->f:Ljava/io/File;
    ...
    iget-wide v2, p0, Landroidx/multidex/MultiDexExtractor;->g:J
    ...
    .line 6
    invoke-direct {p0}, Landroidx/multidex/MultiDexExtractor;->o()Ljava/util/List;
    ...
    invoke-static {v0}, Landroidx/multidex/MultiDexExtractor;->h(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroidx/multidex/MultiDexExtractor;->g:J
    ...
    invoke-static/range {v2 .. v8}, Landroidx/multidex/MultiDexExtractor;->p(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
