...
# interfaces
.implements Lcom/apptentive/android/sdk/storage/PayloadStore;
...
.method public onFinishSending(Lcom/apptentive/android/sdk/storage/PayloadSender;Lcom/apptentive/android/sdk/model/PayloadData;ZLjava/lang/String;ILorg/json/JSONObject;)V
    ...
    const-string p5, "The app went to the background so we won\'t remove the payload from the queue"

    invoke-static {p1, p5, p2}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p5, "Payload failed to send due to a connection error."
    ...
    const-string p5, "Payload failed to send due to a server error."
