...
.method public renderData()[B
    ...
    iget-object v12, v1, Lcom/apptentive/android/sdk/model/CompoundMessage;->boundary:Ljava/lang/String;
    ...
    const-string v13, "Content-Disposition: form-data; name=\"file[]\"; filename=\"%s\""
    ...
    .line 29
    sget-object v14, Lcom/apptentive/android/sdk/ApptentiveLogTag;->PAYLOADS:Lcom/apptentive/android/sdk/ApptentiveLogTag;
    ...
    invoke-static {v14, v6, v15}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0}, Lcom/apptentive/android/sdk/util/Util;->isMimeTypeImage(Ljava/lang/String;)Z
    ...
    invoke-static {v0, v6, v14}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v0, v12}, Lcom/apptentive/android/sdk/util/image/ImageUtil;->appendScaledDownImageToStream(Ljava/lang/String;Ljava/io/OutputStream;)Z
    ...
    invoke-static {v0, v12}, Lcom/apptentive/android/sdk/util/Util;->appendFileToStream(Ljava/io/File;Ljava/io/OutputStream;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 36
    :goto_2
    invoke-static {v13}, Lcom/apptentive/android/sdk/util/Util;->ensureClosed(Ljava/io/Closeable;)V
    ...
    const-string v6, "Content-Disposition: form-data; name=\"file[]\""
    ...
    invoke-static {v6, v14, v13}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v13, "Encrypting attachment bytes: %d"

    invoke-static {v0, v13, v6}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-interface {v8, v0}, Lcom/apptentive/android/sdk/Encryption;->encrypt([B)[B
    ...
    invoke-static {v6, v13, v12}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v6, v12, v14}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V

    .line 51
    invoke-direct {v1, v0}, Lcom/apptentive/android/sdk/model/CompoundMessage;->logException(Ljava/lang/Exception;)V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
