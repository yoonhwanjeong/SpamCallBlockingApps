...
.method private constructor <init>(Landroid/app/Application;Lcom/apptentive/android/sdk/ApptentiveConfiguration;Ljava/lang/String;)V
    .locals 4
    ...
    iput-object v2, p0, Lcom/apptentive/android/sdk/ApptentiveInternal;->surveyTermsAndConditions:Lcom/apptentive/android/sdk/module/engagement/interaction/model/TermsAndConditions;
    ...
    .line 15
    invoke-virtual {p1, v3, v2}, Landroid/app/Application;->getSharedPreferences(Ljava/lang/String;I)Landroid/content/SharedPreferences;
    ...
    .line 16
    new-instance v3, Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;

    invoke-direct {p0, v2}, Lcom/apptentive/android/sdk/ApptentiveInternal;->getEndpointBase(Landroid/content/SharedPreferences;)Ljava/lang/String;

    move-result-object v2

    invoke-direct {v3, v0, v1, v2}, Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;-><init>(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V

    iput-object v3, p0, Lcom/apptentive/android/sdk/ApptentiveInternal;->apptentiveHttpClient:Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;
    ...
    invoke-static {v1, v3, v2}, Lcom/apptentive/android/sdk/util/Util;->getInternalDir(Landroid/content/Context;Ljava/lang/String;Z)Ljava/io/File;

    move-result-object v2

    invoke-direct {p3, v1, v2, p2, v0}, Lcom/apptentive/android/sdk/conversation/ConversationManager;-><init>(Landroid/content/Context;Ljava/io/File;Lcom/apptentive/android/sdk/Encryption;Lcom/apptentive/android/sdk/storage/DeviceManager;)V
    ...
    iget-object p3, p0, Lcom/apptentive/android/sdk/ApptentiveInternal;->appContext:Landroid/content/Context;
    ...
    invoke-direct {p1, p3, v0, p2}, Lcom/apptentive/android/sdk/storage/ApptentiveTaskManager;-><init>(Landroid/content/Context;Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;Lcom/apptentive/android/sdk/Encryption;)V
...
.method static generatePendingIntentFromApptentivePushData(Lcom/apptentive/android/sdk/conversation/Conversation;Ljava/lang/String;)Landroid/app/PendingIntent;
    ...
    const-string v4, "Generating Apptentive push PendingIntent."

    invoke-static {v1, v4, v3}, Lcom/apptentive/android/sdk/ApptentiveLog;->d(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    invoke-static {v4, p1}, Lcom/apptentive/android/sdk/util/StringUtils;->equal(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-static {p0, v0, v1}, Lcom/apptentive/android/sdk/ApptentiveLog;->w(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v1, "Error parsing JSON from push notification."

    invoke-static {p1, p0, v1, v0}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method static getApptentivePushNotificationData(Landroid/os/Bundle;)Ljava/lang/String;
    ...
    const-string v6, "Got a Parse Push."

    invoke-static {v3, v6, v5}, Lcom/apptentive/android/sdk/ApptentiveLog;->v(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string p0, "com.parse.Data is corrupt: %s"

    invoke-static {v3, p0, v4}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
    ...
    const-string v6, "Got an Urban Airship push."
    ...
    const-string v3, "Got an unrecognizable push."

    invoke-static {p0, v3, v2}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method private static resolveAndroidID(Landroid/content/Context;Z)Ljava/lang/String;
    .locals 0
...
.method private static saveAndroidID(Landroid/content/Context;Ljava/lang/String;)V
    .locals 2
...
.method public updateApptentiveInteractionTheme(Landroid/content/Context;Landroid/content/res/Resources$Theme;)V
    ...
    .line 11
    invoke-static {p1, v0}, Landroidx/core/content/ContextCompat;->d(Landroid/content/Context;I)I
