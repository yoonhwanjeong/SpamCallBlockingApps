...
.method public createConversationTokenRequest(Lcom/apptentive/android/sdk/model/ConversationTokenRequest;Lcom/apptentive/android/sdk/network/HttpRequest$Listener;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;
    ...
    invoke-direct {p0, v1, p1, v0}, Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;->createJsonRequest(Ljava/lang/String;Lorg/json/JSONObject;Lcom/apptentive/android/sdk/network/HttpRequestMethod;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;
...
.method public createFirstLoginRequest(Ljava/lang/String;Lcom/apptentive/android/sdk/storage/AppRelease;Lcom/apptentive/android/sdk/storage/Sdk;Lcom/apptentive/android/sdk/storage/Device;Lcom/apptentive/android/sdk/network/HttpRequest$Listener;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;
    ...
    .line 3
    invoke-static {p2, p4}, Lcom/apptentive/android/sdk/storage/DevicePayloadDiff;->getDiffPayload(Lcom/apptentive/android/sdk/storage/Device;Lcom/apptentive/android/sdk/storage/Device;)Lcom/apptentive/android/sdk/model/DevicePayload;
    ...
    .line 5
    :catch_0
    sget-object p1, Lcom/apptentive/android/sdk/network/HttpRequestMethod;->POST:Lcom/apptentive/android/sdk/network/HttpRequestMethod;

    const-string p2, "/conversations"

    invoke-direct {p0, p2, v0, p1}, Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;->createJsonRequest(Ljava/lang/String;Lorg/json/JSONObject;Lcom/apptentive/android/sdk/network/HttpRequestMethod;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;

    move-result-object p1

    .line 6
    invoke-virtual {p1, p5}, Lcom/apptentive/android/sdk/network/HttpRequest;->addListener(Lcom/apptentive/android/sdk/network/HttpRequest$Listener;)V
...
.method public createLegacyConversationIdRequest(Ljava/lang/String;Lcom/apptentive/android/sdk/network/HttpRequest$Listener;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;
    ...
    invoke-direct {p0, v2, v0, v1}, Lcom/apptentive/android/sdk/comm/ApptentiveHttpClient;->createJsonRequest(Ljava/lang/String;Lorg/json/JSONObject;Lcom/apptentive/android/sdk/network/HttpRequestMethod;)Lcom/apptentive/android/sdk/network/HttpJsonRequest;
