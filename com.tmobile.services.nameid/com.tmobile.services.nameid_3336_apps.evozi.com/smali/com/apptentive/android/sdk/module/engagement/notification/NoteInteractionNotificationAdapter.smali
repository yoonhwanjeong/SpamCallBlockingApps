...
.method protected actionButtonPressed(Landroid/content/Context;Landroid/content/Intent;Lcom/apptentive/android/sdk/module/engagement/interaction/model/TextModalInteraction;)V
    ...
    const-string v1, "Unknown Note Interaction Notification button action. Can\'t do anything."

    invoke-static {p2, v1, p3}, Lcom/apptentive/android/sdk/ApptentiveLog;->w(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method protected actionDisplayNotification(Landroid/content/Context;Ljava/lang/String;Lcom/apptentive/android/sdk/module/engagement/interaction/model/TextModalInteraction;)V
    ...
    sget v3, Lcom/apptentive/android/sdk/R$drawable;->apptentive_ic_stat_chat_bubble:I
    ...
    invoke-static {v1, v6, v3, v9}, Landroid/app/PendingIntent;->getBroadcast(Landroid/content/Context;ILandroid/content/Intent;I)Landroid/app/PendingIntent;
    ...
    invoke-virtual {v3, v6}, Landroidx/core/app/NotificationCompat$BigTextStyle;->r(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$BigTextStyle;
    ...
    invoke-virtual {v3, v6}, Landroidx/core/app/NotificationCompat$BigTextStyle;->q(Ljava/lang/CharSequence;)Landroidx/core/app/NotificationCompat$BigTextStyle;
    ...
    .line 22
    invoke-virtual {v3}, Lcom/apptentive/android/sdk/module/engagement/interaction/model/common/Actions;->getAsList()Ljava/util/List;
    ...
    invoke-direct {v13, v6, v11, v12}, Landroidx/core/app/NotificationCompat$Action$Builder;-><init>(ILjava/lang/CharSequence;Landroid/app/PendingIntent;)V

    invoke-virtual {v13}, Landroidx/core/app/NotificationCompat$Action$Builder;->a()Landroidx/core/app/NotificationCompat$Action;

    move-result-object v11

    invoke-virtual {v0, v11}, Landroidx/core/app/NotificationCompat$Builder;->addAction(Landroidx/core/app/NotificationCompat$Action;)Landroidx/core/app/NotificationCompat$Builder;
    ...
    invoke-virtual {v3, v7, v4, v2}, Landroid/content/res/Resources$Theme;->resolveAttribute(ILandroid/util/TypedValue;Z)Z
