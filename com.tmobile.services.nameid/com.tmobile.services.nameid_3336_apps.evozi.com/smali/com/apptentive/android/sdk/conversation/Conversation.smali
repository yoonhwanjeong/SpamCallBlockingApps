...
.method loadConversationData()V
    ...
    invoke-static {v2, v0, v3}, Lcom/apptentive/android/sdk/ApptentiveLog;->d(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method migrateConversationData()Z
    ...
    new-instance v6, Lcom/apptentive/android/sdk/storage/EncryptedFileSerializer;

    invoke-virtual {p0}, Lcom/apptentive/android/sdk/conversation/Conversation;->getEncryption()Lcom/apptentive/android/sdk/Encryption;

    move-result-object v7

    invoke-direct {v6, v3, v7}, Lcom/apptentive/android/sdk/storage/EncryptedFileSerializer;-><init>(Ljava/io/File;Lcom/apptentive/android/sdk/Encryption;)V

    goto :goto_1

    :cond_1
    new-instance v6, Lcom/apptentive/android/sdk/storage/FileSerializer;

    invoke-direct {v6, v3}, Lcom/apptentive/android/sdk/storage/FileSerializer;-><init>(Ljava/io/File;)V

    .line 6
    :goto_1
    invoke-virtual {v6}, Lcom/apptentive/android/sdk/storage/FileSerializer;->deserialize()Ljava/lang/Object;

    move-result-object v6

    check-cast v6, Lcom/apptentive/android/sdk/conversation/ConversationData;

    iput-object v6, p0, Lcom/apptentive/android/sdk/conversation/Conversation;->conversationData:Lcom/apptentive/android/sdk/conversation/ConversationData;
...
.method public setPushIntegration(ILjava/lang/String;)V
    ...
    .line 3
    new-instance v2, Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;

    invoke-direct {v2}, Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;-><init>()V

    .line 4
    invoke-virtual {v2, p2}, Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;->setToken(Ljava/lang/String;)V
    ...
    invoke-static {p2, p1, v0}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/String;[Ljava/lang/Object;)V

    goto :goto_0

    .line 6
    :cond_0
    invoke-virtual {v0, v2}, Lcom/apptentive/android/sdk/storage/IntegrationConfig;->setAmazonAwsSns(Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;)V

    goto :goto_0

    .line 7
    :cond_1
    invoke-virtual {v0, v2}, Lcom/apptentive/android/sdk/storage/IntegrationConfig;->setUrbanAirship(Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;)V

    goto :goto_0

    .line 8
    :cond_2
    invoke-virtual {v0, v2}, Lcom/apptentive/android/sdk/storage/IntegrationConfig;->setParse(Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;)V

    goto :goto_0

    .line 9
    :cond_3
    invoke-virtual {v0, v2}, Lcom/apptentive/android/sdk/storage/IntegrationConfig;->setApptentive(Lcom/apptentive/android/sdk/storage/IntegrationConfigItem;)V
