...
.method private handleLoginFinished(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {v3}, Lcom/apptentive/android/sdk/conversation/ConversationManager;->access$1300(Lcom/apptentive/android/sdk/conversation/ConversationManager;)Lcom/apptentive/android/sdk/storage/DeviceManager;

    move-result-object v3

    iget-object v4, p0, Lcom/apptentive/android/sdk/conversation/ConversationManager$9;->this$0:Lcom/apptentive/android/sdk/conversation/ConversationManager;

    invoke-static {v4}, Lcom/apptentive/android/sdk/conversation/ConversationManager;->access$200(Lcom/apptentive/android/sdk/conversation/ConversationManager;)Landroid/content/Context;

    move-result-object v4

    invoke-virtual {v3, v4}, Lcom/apptentive/android/sdk/storage/DeviceManager;->generateNewDevice(Landroid/content/Context;)Lcom/apptentive/android/sdk/storage/Device;
    ...
    const-string p4, "Exception while creating logged-in conversation"

    invoke-static {p2, p1, p4, p3}, Lcom/apptentive/android/sdk/ApptentiveLog;->e(Lcom/apptentive/android/sdk/ApptentiveLogTag;Ljava/lang/Throwable;Ljava/lang/String;[Ljava/lang/Object;)V
...
.method public onFinish(Lcom/apptentive/android/sdk/network/HttpJsonRequest;)V
    ...
    const-string v2, "Exception while parsing login response"
