...
.method public static d(Lio/reactivex/SingleOnSubscribe;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static f(Ljava/util/concurrent/Callable;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
...
.method public static m(JLjava/util/concurrent/TimeUnit;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    invoke-static {p0, p1, p2, v0}, Lio/reactivex/Single;->n(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
...
.method public static n(JLjava/util/concurrent/TimeUnit;Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
...
.method public final b(Lio/reactivex/SingleObserver;)V
    ...
    .line 4
    :try_start_0
    invoke-virtual {p0, p1}, Lio/reactivex/Single;->k(Lio/reactivex/SingleObserver;)V
    :try_end_0
...
.method public final i()Lio/reactivex/disposables/Disposable;
    .locals 2
    .annotation runtime Lio/reactivex/annotations/SchedulerSupport;
    .end annotation
    ...
    invoke-virtual {p0, v0, v1}, Lio/reactivex/Single;->j(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;
...
.method public final j(Lio/reactivex/functions/Consumer;Lio/reactivex/functions/Consumer;)Lio/reactivex/disposables/Disposable;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method protected abstract k(Lio/reactivex/SingleObserver;)V
...
.method public final l(Lio/reactivex/Scheduler;)Lio/reactivex/Single;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
