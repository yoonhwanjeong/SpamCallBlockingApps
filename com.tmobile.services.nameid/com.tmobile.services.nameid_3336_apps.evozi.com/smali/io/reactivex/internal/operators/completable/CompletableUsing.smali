...
.method protected d(Lio/reactivex/CompletableObserver;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->f:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->g:Lio/reactivex/functions/Function;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->h:Lio/reactivex/functions/Consumer;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->i:Z
    ...
    .line 5
    iget-boolean v2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->i:Z

    if-eqz v2, :cond_0

    .line 6
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->h:Lio/reactivex/functions/Consumer;
    ...
    .line 10
    iget-boolean p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->i:Z

    if-nez p1, :cond_1

    .line 11
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/completable/CompletableUsing;->h:Lio/reactivex/functions/Consumer;
