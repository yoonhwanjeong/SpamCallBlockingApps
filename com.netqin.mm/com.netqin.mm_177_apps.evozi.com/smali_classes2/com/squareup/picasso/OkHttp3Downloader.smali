...
# instance fields
.field public final cache:Lh/c;

.field public final client:Lh/e$a;

.field public sharedClient:Z
...
.method public constructor <init>(Lh/e$a;)V
    ...
    .line 12
    iput-object p1, p0, Lcom/squareup/picasso/OkHttp3Downloader;->client:Lh/e$a;

    const/4 p1, 0x0

    .line 13
    iput-object p1, p0, Lcom/squareup/picasso/OkHttp3Downloader;->cache:Lh/c;
...
.method public constructor <init>(Ljava/io/File;J)V
    ...
    invoke-direct {v1, p1, p2, p3}, Lh/c;-><init>(Ljava/io/File;J)V

    invoke-virtual {v0, v1}, Lh/w$b;->a(Lh/c;)Lh/w$b;

    invoke-virtual {v0}, Lh/w$b;->a()Lh/w;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/squareup/picasso/OkHttp3Downloader;-><init>(Lh/w;)V
...
.method public load(Lh/y;)Lh/a0;
    ...
    .line 1
    iget-object v0, p0, Lcom/squareup/picasso/OkHttp3Downloader;->client:Lh/e$a;

    invoke-interface {v0, p1}, Lh/e$a;->a(Lh/y;)Lh/e;

    move-result-object p1

    invoke-interface {p1}, Lh/e;->execute()Lh/a0;
...
.method public shutdown()V
    ...
    iget-object v0, p0, Lcom/squareup/picasso/OkHttp3Downloader;->cache:Lh/c;

    if-eqz v0, :cond_0

    .line 2
    :try_start_0
    invoke-virtual {v0}, Lh/c;->close()V
    :try_end_0
