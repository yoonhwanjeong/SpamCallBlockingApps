...
.method public static decodeStream(Li/q;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
    .locals 7
    ...
    .line 1
    invoke-static {p0}, Li/k;->a(Li/q;)Li/e;

    move-result-object p0

    .line 2
    invoke-static {p0}, Lcom/squareup/picasso/Utils;->isWebPFile(Li/e;)Z
    ...
    .line 6
    :cond_1
    invoke-interface {p0}, Li/e;->e2()Ljava/io/InputStream;
...
.method public static transformResult(Lcom/squareup/picasso/Request;Landroid/graphics/Bitmap;I)Landroid/graphics/Bitmap;
    ...
    iget v5, v0, Lcom/squareup/picasso/Request;->targetHeight:I
...
.method public hunt()Landroid/graphics/Bitmap;
    ...
    .line 12
    invoke-virtual {v1}, Lcom/squareup/picasso/RequestHandler$Result;->getSource()Li/q;
    ...
    invoke-static {v0, v1}, Lcom/squareup/picasso/BitmapHunter;->decodeStream(Li/q;Lcom/squareup/picasso/Request;)Landroid/graphics/Bitmap;
