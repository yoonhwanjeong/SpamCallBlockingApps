...
.field public final isEqual:Ld/c/a0/d;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ld/c/a0/d<",
            "-TT;-TT;>;"
...
# direct methods
.method public constructor <init>(Ld/c/u;Ld/c/a0/d;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->actual:Ld/c/u;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->isEqual:Ld/c/a0/d;
...
.method public done()V
    ...
    .line 4
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->isEqual:Ld/c/a0/d;

    invoke-interface {v2, v0, v1}, Ld/c/a0/d;->a(Ljava/lang/Object;Ljava/lang/Object;)Z
    ...
    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->actual:Ld/c/u;
    ...
    .line 8
    :cond_0
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->actual:Ld/c/u;
    ...
    invoke-interface {v2, v0}, Ld/c/u;->onSuccess(Ljava/lang/Object;)V
...
.method public error(Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualObserver;Ljava/lang/Throwable;)V
    ...
    .line 5
    :goto_0
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeEqualSingle$EqualCoordinator;->actual:Ld/c/u;

    invoke-interface {p1, p2}, Ld/c/u;->onError(Ljava/lang/Throwable;)V
...
.method public subscribe(Ld/c/m;Ld/c/m;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-interface {p2, p1}, Ld/c/m;->a(Ld/c/k;)V
