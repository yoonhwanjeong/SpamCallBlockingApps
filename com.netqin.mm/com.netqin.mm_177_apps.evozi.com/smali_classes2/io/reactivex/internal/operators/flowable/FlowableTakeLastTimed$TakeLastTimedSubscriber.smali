...
# direct methods
.method public constructor <init>(Lj/a/c;JJLjava/util/concurrent/TimeUnit;Ld/c/s;IZ)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->actual:Lj/a/c;
    ...
    .line 7
    iput-object p7, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ld/c/s;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Ld/c/b0/f/a;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->s:Lj/a/d;
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Ld/c/b0/f/a;
...
.method public checkTerminated(ZLj/a/c;Z)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(Z",
    ...
    .line 2
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Ld/c/b0/f/a;
    ...
    .line 8
    invoke-interface {p2, p3}, Lj/a/c;->onError(Ljava/lang/Throwable;)V
...
.method public drain()V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->actual:Lj/a/c;

    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Ld/c/b0/f/a;
    ...
    .line 6
    invoke-virtual {v1}, Ld/c/b0/f/a;->isEmpty()Z

    move-result v5

    .line 7
    invoke-virtual {p0, v5, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLj/a/c;Z)Z
    ...
    .line 9
    :goto_0
    invoke-virtual {v1}, Ld/c/b0/f/a;->peek()Ljava/lang/Object;
    ...
    .line 10
    :goto_1
    invoke-virtual {p0, v11, v0, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->checkTerminated(ZLj/a/c;Z)Z
    ...
    .line 14
    invoke-interface {v0, v11}, Lj/a/c;->onNext(Ljava/lang/Object;)V
...
.method public onComplete()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ld/c/s;
    ...
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->queue:Ld/c/b0/f/a;

    invoke-virtual {p0, v0, v1, v2}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLd/c/b0/f/a;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->scheduler:Ld/c/s;
    ...
    invoke-virtual {v0, v3, p1}, Ld/c/b0/f/a;->a(Ljava/lang/Object;Ljava/lang/Object;)Z

    .line 4
    invoke-virtual {p0, v1, v2, v0}, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->trim(JLd/c/b0/f/a;)V
...
.method public onSubscribe(Lj/a/d;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableTakeLastTimed$TakeLastTimedSubscriber;->s:Lj/a/d;
...
.method public trim(JLd/c/b0/f/a;)V
    .locals 11
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(J",
    ...
    .line 3
    :goto_0
    invoke-virtual {p3}, Ld/c/b0/f/a;->isEmpty()Z
    ...
    .line 4
    invoke-virtual {p3}, Ld/c/b0/f/a;->peek()Ljava/lang/Object;
    ...
    .line 5
    invoke-virtual {p3}, Ld/c/b0/f/a;->e()I
    ...
    .line 6
    :cond_1
    invoke-virtual {p3}, Ld/c/b0/f/a;->poll()Ljava/lang/Object;
