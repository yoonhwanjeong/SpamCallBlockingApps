...
.method public constructor <init>(Ld/c/r;Ld/c/a0/h;ZII)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;

    .line 4
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Ld/c/a0/h;
...
.method public checkTerminate()Z
    ...
    .line 7
    iget-object v2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;
...
.method public disposeAll()Z
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->s:Ld/c/x/b;
...
.method public drainLoop()V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;
    ...
    .line 3
    :cond_1
    iget-object v3, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Ld/c/b0/c/i;
    ...
    .line 5
    :cond_3
    invoke-interface {v3}, Ld/c/b0/c/i;->poll()Ljava/lang/Object;
    ...
    .line 6
    :cond_4
    invoke-interface {v0, v4}, Ld/c/r;->onNext(Ljava/lang/Object;)V
    ...
    .line 8
    iget-object v4, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Ld/c/b0/c/i;
    ...
    .line 29
    :cond_13
    iget-object v11, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Ld/c/b0/c/j;
    ...
    :cond_14
    :try_start_1
    invoke-interface {v11}, Ld/c/b0/c/j;->poll()Ljava/lang/Object;
    ...
    .line 32
    iget-object v12, v10, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Ld/c/b0/c/j;
    ...
    .line 33
    invoke-interface {v12}, Ld/c/b0/c/j;->isEmpty()Z
    ...
    .line 36
    :cond_18
    invoke-interface {v0, v12}, Ld/c/r;->onNext(Ljava/lang/Object;)V
    ...
    .line 51
    invoke-virtual {p0, v3}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Ld/c/q;)V
...
.method public onNext(Ljava/lang/Object;)V
    ...
    :cond_0
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->mapper:Ld/c/a0/h;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, p1}, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->subscribeInner(Ld/c/q;)V
...
.method public onSubscribe(Ld/c/x/b;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->s:Ld/c/x/b;

    .line 3
    iget-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;
...
.method public subscribeInner(Ld/c/q;)V
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public tryEmit(Ljava/lang/Object;Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;)V
    ...
    .line 2
    iget-object p2, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;

    invoke-interface {p2, p1}, Ld/c/r;->onNext(Ljava/lang/Object;)V
    ...
    .line 4
    :cond_0
    iget-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Ld/c/b0/c/j;
    ...
    .line 6
    iput-object v0, p2, Lio/reactivex/internal/operators/observable/ObservableFlatMap$InnerObserver;->queue:Ld/c/b0/c/j;
...
.method public tryEmitScalar(Ljava/util/concurrent/Callable;)Z
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->actual:Ld/c/r;

    invoke-interface {v1, p1}, Ld/c/r;->onNext(Ljava/lang/Object;)V
    ...
    .line 5
    :cond_1
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Ld/c/b0/c/i;
    ...
    .line 9
    :goto_0
    iput-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableFlatMap$MergeObserver;->queue:Ld/c/b0/c/i;

    .line 10
    :cond_3
    invoke-interface {v1, p1}, Ld/c/b0/c/j;->offer(Ljava/lang/Object;)Z
