...
.field public final observers:[Ld/c/b0/e/d/q;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "[",
            "Ld/c/b0/e/d/q<",
...
# direct methods
.method public constructor <init>(Ld/c/r;ILd/c/q;Ld/c/q;Ld/c/a0/d;)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->actual:Ld/c/r;

    .line 3
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->first:Ld/c/q;

    .line 4
    iput-object p4, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->second:Ld/c/q;

    .line 5
    iput-object p5, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->comparer:Ld/c/a0/d;

    const/4 p1, 0x2

    new-array p3, p1, [Ld/c/b0/e/d/q;

    .line 6
    iput-object p3, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->observers:[Ld/c/b0/e/d/q;

    .line 7
    new-instance p4, Ld/c/b0/e/d/q;

    const/4 p5, 0x0

    invoke-direct {p4, p0, p5, p2}, Ld/c/b0/e/d/q;-><init>(Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;II)V
...
.method public dispose()V
    ...
    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->observers:[Ld/c/b0/e/d/q;
    ...
    iget-object v2, v2, Ld/c/b0/e/d/q;->b:Ld/c/b0/f/a;
    ...
    iget-object v0, v0, Ld/c/b0/e/d/q;->b:Ld/c/b0/f/a;
...
.method public drain()V
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->observers:[Ld/c/b0/e/d/q;
    ...
    .line 4
    iget-object v3, v2, Ld/c/b0/e/d/q;->b:Ld/c/b0/f/a;
    ...
    .line 6
    iget-object v5, v0, Ld/c/b0/e/d/q;->b:Ld/c/b0/f/a;
    ...
    .line 10
    :cond_2
    iget-boolean v7, v2, Ld/c/b0/e/d/q;->d:Z

    if-eqz v7, :cond_3

    .line 11
    iget-object v8, v2, Ld/c/b0/e/d/q;->e:Ljava/lang/Throwable;

    if-eqz v8, :cond_3

    .line 12
    invoke-virtual {p0, v3, v5}, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->cancel(Ld/c/b0/f/a;Ld/c/b0/f/a;)V

    .line 13
    iget-object v0, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->actual:Ld/c/r;

    invoke-interface {v0, v8}, Ld/c/r;->onError(Ljava/lang/Throwable;)V

    return-void

    .line 14
    :cond_3
    iget-boolean v8, v0, Ld/c/b0/e/d/q;->d:Z

    if-eqz v8, :cond_4

    .line 15
    iget-object v9, v0, Ld/c/b0/e/d/q;->e:Ljava/lang/Throwable;
    ...
    invoke-interface {v0, v9}, Ld/c/r;->onError(Ljava/lang/Throwable;)V
    ...
    .line 29
    :try_start_0
    iget-object v7, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->comparer:Ld/c/a0/d;
    ...
    .line 37
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->actual:Ld/c/r;
...
.method public subscribe()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->first:Ld/c/q;
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/ObservableSequenceEqual$EqualCoordinator;->second:Ld/c/q;
