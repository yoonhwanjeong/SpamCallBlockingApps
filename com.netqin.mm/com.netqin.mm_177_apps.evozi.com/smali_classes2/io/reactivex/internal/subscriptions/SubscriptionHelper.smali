...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 5
    invoke-interface {p0}, Lj/a/d;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Lj/a/d;->request(J)V
    ...
    .line 4
    invoke-static {p1, p2, p3}, Ld/c/b0/i/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Lj/a/d;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lj/a/d;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Lj/a/d;->request(J)V
...
.method public static isCancelled(Lj/a/d;)Z
    .locals 1
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Lj/a/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Lj/a/d;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lj/a/d;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Lj/a/d;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Lj/a/d;->request(J)V
...
.method public static validate(Lj/a/d;Lj/a/d;)Z
    .locals 1
    ...
    invoke-static {p0}, Ld/c/e0/a;->b(Ljava/lang/Throwable;)V
