...
.method public run()V
    ...
    iget-boolean v2, v1, Landroidx/media2/widget/MediaControlView;->u:Z

    if-nez v2, :cond_1

    if-eqz v0, :cond_1

    iget-object v0, v1, Landroidx/media2/widget/MediaControlView;->d:Lb/s/e/i;
    ...
    invoke-virtual {v0}, Landroidx/media2/widget/MediaControlView;->l()J
    ...
    iget-object v3, v2, Landroidx/media2/widget/MediaControlView;->C0:Ljava/lang/Runnable;
