...
.method private final bodyHasUnknownEncoding(Lokhttp3/Headers;)Z
    ...
    .line 291
    invoke-static {p1, v1}, Lkotlin/h/p;->a(Ljava/lang/String;Ljava/lang/String;)Z
...
.method public final intercept(Lokhttp3/Interceptor$Chain;)Lokhttp3/Response;
    ...
    .line 189
    invoke-direct {v1, v8, v11}, Lokhttp3/logging/HttpLoggingInterceptor;->logHeader(Lokhttp3/Headers;I)V
    ...
    invoke-virtual {v7, v11}, Lokhttp3/RequestBody;->writeTo(Lc/g;)V
    ...
    invoke-virtual {v11, v12}, Lokhttp3/MediaType;->charset(Ljava/nio/charset/Charset;)Ljava/nio/charset/Charset;
    ...
    invoke-static {v11, v6}, Lkotlin/jvm/internal/p;->b(Ljava/lang/Object;Ljava/lang/String;)V
    ...
    .line 208
    invoke-static {v10}, Lokhttp3/logging/Utf8Kt;->isProbablyUtf8(Lc/f;)Z
    ...
    invoke-virtual {v10, v11}, Lc/f;->a(Ljava/nio/charset/Charset;)Ljava/lang/String;

    move-result-object v10

    invoke-interface {v12, v10}, Lokhttp3/logging/HttpLoggingInterceptor$Logger;->log(Ljava/lang/String;)V
    ...
    .line 246
    :cond_18
    invoke-virtual {v3}, Lokhttp3/ResponseBody;->source()Lc/h;
    ...
    .line 247
    invoke-interface {v4, v7, v8}, Lc/h;->b(J)Z

    .line 248
    invoke-interface {v4}, Lc/h;->b()Lc/f;
    ...
    invoke-static {v5, v2}, Lkotlin/h/p;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v4}, Lc/f;->w()Lc/f;

    move-result-object v4

    check-cast v4, Lc/ad;

    invoke-direct {v7, v4}, Lc/n;-><init>(Lc/ad;)V
    ...
    invoke-direct {v8}, Lc/f;-><init>()V

    .line 255
    check-cast v4, Lc/ad;

    invoke-virtual {v8, v4}, Lc/f;->a(Lc/ad;)J
    :try_end_1
    ...
    invoke-static {v7, v2}, Lkotlin/io/b;->a(Ljava/io/Closeable;Ljava/lang/Throwable;)V
    ...
    .line 262
    :cond_1b
    invoke-static {v4}, Lokhttp3/logging/Utf8Kt;->isProbablyUtf8(Lc/f;)Z
    ...
    invoke-virtual {v6, v2}, Lc/f;->a(Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method public final redactHeader(Ljava/lang/String;)V
    ...
    invoke-static {v1}, Lkotlin/h/p;->a(Lkotlin/jvm/internal/ag;)Ljava/util/Comparator;
