...
.method public constructor <init>(Lc/h;Z)V
    ...
    iput-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;
    ...
    invoke-direct {p2, p1}, Lokhttp3/internal/http2/Http2Reader$ContinuationSource;-><init>(Lc/h;)V
    ...
    .line 64
    invoke-direct/range {v0 .. v5}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lc/ad;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final readData(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 177
    iget-object v1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {v1}, Lc/h;->i()B
    ...
    .line 180
    iget-object p3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {p1, v0, p4, p3, p2}, Lokhttp3/internal/http2/Http2Reader$Handler;->data(ZILc/h;I)V

    .line 181
    iget-object p1, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    int-to-long p2, v1

    invoke-interface {p1, p2, p3}, Lc/h;->h(J)V
...
.method private final readGoAway(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 294
    iget-object p4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {p4}, Lc/h;->k()I

    move-result p4

    .line 295
    iget-object v0, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {v0}, Lc/h;->k()I
    ...
    invoke-interface {v0, v1, v2}, Lc/h;->d(J)Lc/i;

    move-result-object v0

    .line 303
    :cond_0
    invoke-interface {p1, p4, p3, v0}, Lokhttp3/internal/http2/Http2Reader$Handler;->goAway(ILokhttp3/internal/http2/ErrorCode;Lc/i;)V
...
.method private final readPing(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 284
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {p2}, Lc/h;->k()I
...
.method private final readPriority(Lokhttp3/internal/http2/Http2Reader$Handler;I)V
    ...
    .line 196
    iget-object v3, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {v3}, Lc/h;->i()B
...
.method private final readSettings(Lokhttp3/internal/http2/Http2Reader$Handler;III)V
    ...
    .line 221
    invoke-static {v0, p2}, Lkotlin/f/d;->b(II)Lkotlin/f/c;

    move-result-object p2

    check-cast p2, Lkotlin/f/a;

    const/4 v1, 0x6

    invoke-static {p2, v1}, Lkotlin/f/d;->a(Lkotlin/f/a;I)Lkotlin/f/a;

    move-result-object p2

    .line 2087
    iget v1, p2, Lkotlin/f/a;->a:I

    .line 2092
    iget v2, p2, Lkotlin/f/a;->b:I

    .line 2097
    iget p2, p2, Lkotlin/f/a;->c:I
    ...
    .line 223
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Reader;->source:Lc/h;

    invoke-interface {v4}, Lc/h;->k()I
...
.method public final nextFrame(ZLokhttp3/internal/http2/Http2Reader$Handler;)Z
    ...
    invoke-interface {v0, v1, v2}, Lc/h;->a(J)V
    :try_end_0
    ...
    invoke-static {v0}, Lokhttp3/internal/Util;->readMedium(Lc/h;)I
    ...
    invoke-interface {p1, v0, v1}, Lc/h;->h(J)V
...
.method public final readConnectionPreface(Lokhttp3/internal/http2/Http2Reader$Handler;)V
    ...
    sget-object v0, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lc/i;
    ...
    .line 78
    invoke-interface {p1, v2, v3}, Lc/h;->d(J)Lc/i;
