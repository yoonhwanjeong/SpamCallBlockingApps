...
# direct methods
.method public constructor <init>(Lc/ad;I)V
    .locals 6
...
.method public constructor <init>(Lc/ad;II)V
    .locals 1
    ...
    .line 131
    iput-object p1, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lc/h;
...
.method public synthetic constructor <init>(Lc/ad;IIILkotlin/jvm/internal/DefaultConstructorMarker;)V
    .locals 0
    ...
    .line 128
    :cond_0
    invoke-direct {p0, p1, p2, p3}, Lokhttp3/internal/http2/Hpack$Reader;-><init>(Lc/ad;II)V
...
.method private final getName(I)Lc/i;
    .locals 3
    ...
    iget-object p1, p1, Lokhttp3/internal/http2/Header;->name:Lc/i;
...
.method private final readByte()I
    ...
    .line 339
    iget-object v0, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lc/h;
...
.method private final readLiteralHeaderWithIncrementalIndexingIndexedName(I)V
    ...
    .line 270
    invoke-direct {p0, p1}, Lokhttp3/internal/http2/Hpack$Reader;->getName(I)Lc/i;

    move-result-object p1

    .line 271
    invoke-virtual {p0}, Lokhttp3/internal/http2/Hpack$Reader;->readByteString()Lc/i;
    ...
    invoke-direct {v1, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lc/i;Lc/i;)V
...
.method private final readLiteralHeaderWithIncrementalIndexingNewName()V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/internal/http2/Hpack;->checkLowercase(Lc/i;)Lc/i;
    ...
    invoke-direct {v2, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lc/i;Lc/i;)V
...
.method private final readLiteralHeaderWithoutIndexingIndexedName(I)V
    ...
    invoke-direct {v2, p1, v0}, Lokhttp3/internal/http2/Header;-><init>(Lc/i;Lc/i;)V
...
.method private final readLiteralHeaderWithoutIndexingNewName()V
    ...
    invoke-direct {v3, v0, v1}, Lokhttp3/internal/http2/Header;-><init>(Lc/i;Lc/i;)V
...
.method public final readByteString()Lc/i;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Hpack$Reader;->source:Lc/h;

    move-object v5, v0

    check-cast v5, Lc/g;

    invoke-virtual {v1, v4, v2, v3, v5}, Lokhttp3/internal/http2/Huffman;->decode(Lc/h;JLc/g;)V
    ...
    invoke-interface {v0, v2, v3}, Lc/h;->d(J)Lc/i;
