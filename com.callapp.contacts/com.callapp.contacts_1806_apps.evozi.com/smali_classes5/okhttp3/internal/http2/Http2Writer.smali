...
.method public constructor <init>(Lc/g;Z)V
    ...
    iput-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/f;
    ...
    invoke-direct/range {v1 .. v6}, Lokhttp3/internal/http2/Hpack$Writer;-><init>(IZLc/f;ILkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method private final writeContinuationFrames(IJ)V
    ...
    invoke-interface {v0, v1, v2, v3}, Lc/g;->write(Lc/f;J)V
...
.method public final declared-synchronized connectionPreface()V
    ...
    sget-object v2, Lokhttp3/internal/http2/Http2;->CONNECTION_PREFACE:Lc/i;
    ...
    invoke-interface {v0, v1}, Lc/g;->b(Lc/i;)Lc/g;
...
.method public final declared-synchronized data(ZILc/f;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 153
    invoke-virtual {p0, p2, p1, p3, p4}, Lokhttp3/internal/http2/Http2Writer;->dataFrame(IILc/f;I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public final dataFrame(IILc/f;I)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-interface {p1, p3, v0, v1}, Lc/g;->write(Lc/f;J)V
...
.method public final frameHeader(IIII)V
    ...
    invoke-static {v0, p2}, Lokhttp3/internal/Util;->writeMedium(Lc/g;I)V
    ...
    invoke-interface {p2, p3}, Lc/g;->c(I)Lc/g;
    ...
    invoke-interface {p2, p1}, Lc/g;->g(I)Lc/g;
...
.method public final declared-synchronized goAway(ILokhttp3/internal/http2/ErrorCode;[B)V
    ...
    invoke-interface {v0, p1}, Lc/g;->g(I)Lc/g;
    ...
    invoke-interface {p1, p2}, Lc/g;->g(I)Lc/g;
    ...
    invoke-interface {p1, p3}, Lc/g;->c([B)Lc/g;
...
.method public final declared-synchronized headers(ZILjava/util/List;)V
    ...
    iget-object v4, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/f;

    invoke-interface {p1, v4, v2, v3}, Lc/g;->write(Lc/f;J)V
...
.method public final declared-synchronized ping(ZII)V
    ...
    invoke-interface {p1, p3}, Lc/g;->g(I)Lc/g;
...
.method public final declared-synchronized pushPromise(IILjava/util/List;)V
    ...
    .line 111
    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lc/g;

    const v3, 0x7fffffff

    and-int/2addr p2, v3

    invoke-interface {v2, p2}, Lc/g;->g(I)Lc/g;

    .line 112
    iget-object p2, p0, Lokhttp3/internal/http2/Http2Writer;->sink:Lc/g;

    iget-object v2, p0, Lokhttp3/internal/http2/Http2Writer;->hpackBuffer:Lc/f;

    invoke-interface {p2, v2, v4, v5}, Lc/g;->write(Lc/f;J)V
...
.method public final declared-synchronized settings(Lokhttp3/internal/http2/Settings;)V
    ...
    invoke-interface {v3, v0}, Lc/g;->e(I)Lc/g;
    ...
    invoke-interface {v0, v3}, Lc/g;->g(I)Lc/g;
