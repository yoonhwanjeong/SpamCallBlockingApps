...
# static fields
.field private static final QUOTED_STRING_DELIMITERS:Lc/i;

.field private static final TOKEN_DELIMITERS:Lc/i;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lc/i;
    ...
    sput-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lc/i;
...
.method public static final parseChallenges(Lokhttp3/Headers;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-static {p1, v3}, Lkotlin/h/p;->a(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    invoke-virtual {v3, v4}, Lc/f;->a(Ljava/lang/String;)Lc/f;

    move-result-object v3

    .line 65
    :try_start_0
    invoke-static {v3, v0}, Lokhttp3/internal/http/HttpHeaders;->readChallengeHeader(Lc/f;Ljava/util/List;)V
    :try_end_0
...
.method private static final readChallengeHeader(Lc/f;Ljava/util/List;)V
    .locals 7
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 81
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->skipCommasAndWhitespace(Lc/f;)Z

    .line 82
    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readToken(Lc/f;)Ljava/lang/String;
    ...
    .line 97
    invoke-static {p0, v4}, Lokhttp3/internal/Util;->skipAll(Lc/f;B)I
    ...
    invoke-static {v3, v5}, Lkotlin/h/p;->a(Ljava/lang/CharSequence;I)Ljava/lang/String;
    ...
    .line 122
    invoke-static {p0, v6}, Lokhttp3/internal/http/HttpHeaders;->startsWith(Lc/f;B)Z

    move-result v6

    if-eqz v6, :cond_8

    invoke-static {p0}, Lokhttp3/internal/http/HttpHeaders;->readQuotedString(Lc/f;)Ljava/lang/String;
...
.method private static final readQuotedString(Lc/f;)Ljava/lang/String;
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/EOFException;
    ...
    .line 169
    :goto_1
    sget-object v2, Lokhttp3/internal/http/HttpHeaders;->QUOTED_STRING_DELIMITERS:Lc/i;

    invoke-virtual {p0, v2}, Lc/f;->c(Lc/i;)J
    ...
    .line 173
    invoke-virtual {v0, p0, v2, v3}, Lc/f;->write(Lc/f;J)V
    ...
    .line 183
    invoke-virtual {v0, p0, v7, v8}, Lc/f;->write(Lc/f;J)V
...
.method private static final readToken(Lc/f;)Ljava/lang/String;
    .locals 5

    .line 192
    sget-object v0, Lokhttp3/internal/http/HttpHeaders;->TOKEN_DELIMITERS:Lc/i;

    invoke-virtual {p0, v0}, Lc/f;->c(Lc/i;)J
    ...
    .line 196
    invoke-virtual {p0, v0, v1}, Lc/f;->e(J)Ljava/lang/String;
...
.method private static final skipCommasAndWhitespace(Lc/f;)Z
    .locals 3
...
.method private static final startsWith(Lc/f;B)Z
    .locals 2
