...
.method private final newSource(I)Lc/ad;
    .locals 2
    ...
    invoke-interface {v0, p1}, Lokhttp3/internal/io/FileSystem;->source(Ljava/io/File;)Lc/ad;
    ...
    invoke-direct {v0, p0, p1, p1}, Lokhttp3/internal/cache/DiskLruCache$Entry$newSource$1;-><init>(Lokhttp3/internal/cache/DiskLruCache$Entry;Lc/ad;Lc/ad;)V
...
.method public final snapshot$okhttp()Lokhttp3/internal/cache/DiskLruCache$Snapshot;
    ...
    invoke-direct {p0, v2}, Lokhttp3/internal/cache/DiskLruCache$Entry;->newSource(I)Lc/ad;
...
.method public final writeLengths$okhttp(Lc/g;)V
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 986
    invoke-interface {p1, v5}, Lc/g;->c(I)Lc/g;

    move-result-object v5

    invoke-interface {v5, v3, v4}, Lc/g;->k(J)Lc/g;
