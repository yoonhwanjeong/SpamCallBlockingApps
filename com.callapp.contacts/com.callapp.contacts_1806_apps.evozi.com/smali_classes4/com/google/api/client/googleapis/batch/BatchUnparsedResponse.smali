...
.method private getFakeResponse(ILjava/io/InputStream;Ljava/util/List;Ljava/util/List;)Lcom/google/api/client/http/t;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(I",
    ...
    .line 243
    invoke-virtual {v0}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse$FakeResponseHttpTransport;->createRequestFactory()Lcom/google/api/client/http/r;

    move-result-object p1

    new-instance p2, Lcom/google/api/client/http/i;

    const-string p3, "http://google.com/"

    invoke-direct {p2, p3}, Lcom/google/api/client/http/i;-><init>(Ljava/lang/String;)V

    const/4 p3, 0x0

    .line 244
    invoke-virtual {p1, p2, p3}, Lcom/google/api/client/http/r;->a(Lcom/google/api/client/http/i;Lcom/google/api/client/http/j;)Lcom/google/api/client/http/q;

    move-result-object p1

    .line 245
    invoke-virtual {p1}, Lcom/google/api/client/http/q;->f()Lcom/google/api/client/http/q;
...
.method private getParsedDataClass(Ljava/lang/Class;Lcom/google/api/client/http/t;Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;)Ljava/lang/Object;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<A:",
    ...
    .line 234
    :cond_0
    iget-object p3, p3, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->request:Lcom/google/api/client/http/q;

    invoke-virtual {p3}, Lcom/google/api/client/http/q;->m()Lcom/google/api/client/a/x;

    move-result-object p3

    .line 235
    invoke-virtual {p2}, Lcom/google/api/client/http/t;->h()Ljava/io/InputStream;

    move-result-object v0

    invoke-virtual {p2}, Lcom/google/api/client/http/t;->l()Ljava/nio/charset/Charset;

    move-result-object p2

    .line 234
    invoke-interface {p3, v0, p2, p1}, Lcom/google/api/client/a/x;->parseAndClose(Ljava/io/InputStream;Ljava/nio/charset/Charset;Ljava/lang/Class;)Ljava/lang/Object;
...
.method private parseAndCallback(Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;ILcom/google/api/client/http/t;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "<T:",
    ...
    .line 183
    invoke-virtual {p3}, Lcom/google/api/client/http/t;->c()Lcom/google/api/client/http/n;

    move-result-object v1

    .line 184
    iget-object v2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->request:Lcom/google/api/client/http/q;

    .line 185
    invoke-virtual {v2}, Lcom/google/api/client/http/q;->i()Lcom/google/api/client/http/x;

    move-result-object v2

    .line 186
    iget-object v3, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->request:Lcom/google/api/client/http/q;

    invoke-virtual {v3}, Lcom/google/api/client/http/q;->e()Lcom/google/api/client/http/c;
    ...
    .line 191
    invoke-static {p2}, Lcom/google/api/client/http/v;->a(I)Z
    ...
    invoke-direct {p0, p2, p3, p1}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->getParsedDataClass(Ljava/lang/Class;Lcom/google/api/client/http/t;Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;)Ljava/lang/Object;

    move-result-object p1

    .line 197
    invoke-interface {v0, p1, v1}, Lcom/google/api/client/googleapis/batch/BatchCallback;->onSuccess(Ljava/lang/Object;Lcom/google/api/client/http/n;)V

    return-void

    .line 199
    :cond_1
    iget-object p2, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->request:Lcom/google/api/client/http/q;

    invoke-virtual {p2}, Lcom/google/api/client/http/q;->d()Lcom/google/api/client/http/j;
    ...
    invoke-interface {p2}, Lcom/google/api/client/http/j;->retrySupported()Z
    ...
    .line 204
    iget-object v5, p1, Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;->request:Lcom/google/api/client/http/q;

    invoke-interface {v2, v5, p3, p2}, Lcom/google/api/client/http/x;->a(Lcom/google/api/client/http/q;Lcom/google/api/client/http/t;Z)Z
    ...
    invoke-virtual {p3}, Lcom/google/api/client/http/t;->e()I
    ...
    invoke-virtual {v5, v7, v8}, Lcom/google/api/client/http/q;->a(ILcom/google/api/client/http/n;)Z
    ...
    invoke-interface {v3}, Lcom/google/api/client/http/c;->a()Z
    ...
    .line 223
    invoke-interface {v0, p1, v1}, Lcom/google/api/client/googleapis/batch/BatchCallback;->onFailure(Ljava/lang/Object;Lcom/google/api/client/http/n;)V
...
# virtual methods
.method final parseNextResponse()V
    .locals 12
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-static {v6, v7, v8}, Lcom/google/api/client/a/f;->a(Ljava/io/InputStream;J)Ljava/io/InputStream;
    ...
    .line 153
    :goto_2
    invoke-direct {p0, v0, v5, v3, v4}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->getFakeResponse(ILjava/io/InputStream;Ljava/util/List;Ljava/util/List;)Lcom/google/api/client/http/t;
    ...
    invoke-direct {p0, v1, v0, v3}, Lcom/google/api/client/googleapis/batch/BatchUnparsedResponse;->parseAndCallback(Lcom/google/api/client/googleapis/batch/BatchRequest$RequestInfo;ILcom/google/api/client/http/t;)V
