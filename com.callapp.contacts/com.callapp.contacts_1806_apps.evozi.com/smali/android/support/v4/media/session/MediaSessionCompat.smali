...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroid/os/Bundle;Landroidx/versionedparcelable/c;)V
    ...
    invoke-direct {p3, p1, p2, p5}, Landroid/media/session/MediaSession;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    .line 566
    new-instance p2, Landroid/support/v4/media/session/MediaSessionCompat$g;

    invoke-direct {p2, p3, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$g;-><init>(Landroid/media/session/MediaSession;Landroidx/versionedparcelable/c;Landroid/os/Bundle;)V
    ...
    invoke-direct {p2, p3, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$f;-><init>(Landroid/media/session/MediaSession;Landroidx/versionedparcelable/c;Landroid/os/Bundle;)V
    ...
    invoke-direct {p2, p3, p6, p5}, Landroid/support/v4/media/session/MediaSessionCompat$e;-><init>(Landroid/media/session/MediaSession;Landroidx/versionedparcelable/c;Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v2 .. v8}, Landroid/support/v4/media/session/MediaSessionCompat$c;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroidx/versionedparcelable/c;Landroid/os/Bundle;)V
    ...
    invoke-direct/range {v2 .. v8}, Landroid/support/v4/media/session/MediaSessionCompat$h;-><init>(Landroid/content/Context;Ljava/lang/String;Landroid/content/ComponentName;Landroid/app/PendingIntent;Landroidx/versionedparcelable/c;Landroid/os/Bundle;)V
...
.method public final a()V
    ...
    invoke-interface {v0, v1}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(Z)V
...
.method public final a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
    ...
    :goto_1
    invoke-interface {p1, v0, p2}, Landroid/support/v4/media/session/MediaSessionCompat$b;->a(Landroid/support/v4/media/session/MediaSessionCompat$a;Landroid/os/Handler;)V
...
.method public final b()Landroidx/media/b$b;
    ...
    invoke-interface {v0}, Landroid/support/v4/media/session/MediaSessionCompat$b;->e()Landroidx/media/b$b;
